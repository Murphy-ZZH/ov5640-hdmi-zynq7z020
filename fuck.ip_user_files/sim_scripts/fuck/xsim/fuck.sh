...
#
# Script generated by Vivado on Mon Dec 23 01:22:16 +0800 2024
...
#
# Usage        : fuck.sh
#                fuck.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fuck.sh [-reset_run]
#                fuck.sh [-reset_log]
#                fuck.sh [-help]
#
...
export RDI_DATADIR="I:/Vivado/2024.2/data"
...
# script info
echo -e "fuck.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fuck.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L v_vid_in_axi4s_v5_0_5 -L util_vector_logic_v2_0_4 -L lib_cdc_v1_0_3 -L lib_pkg_v1_0_4 -L fifo_generator_v13_2_11 -L lib_fifo_v1_0_20 -L blk_mem_gen_v8_4_9 -L lib_bmg_v1_0_18 -L lib_srl_fifo_v1_0_4 -L axi_datamover_v5_1_35 -L axi_vdma_v6_3_21 -L axi_lite_ipif_v3_0_4 -L v_tc_v6_2_9 -L v_tc_v6_1_14 -L v_vid_in_axi4s_v4_0_11 -L v_axi4s_vid_out_v4_0_19 -L xlconstant_v1_1_9 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L generic_baseblocks_v2_1_2 -L axi_data_fifo_v2_1_32 -L axi_crossbar_v2_1_34 -L axi_protocol_converter_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fuck xil_defaultlib.fuck xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fuck -key {Behavioral:sim_1:Functional:fuck} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_a73f.protoinst" -protoinst "protoinst_files/fuck.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="I:/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fuck.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fuck.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fuck.sh [-help]\n\
Usage: fuck.sh [-step]\n\
Usage: fuck.sh [-lib_map_path]\n\
Usage: fuck.sh [-reset_run]\n\
Usage: fuck.sh [-reset_log]\n\
Usage: fuck.sh [-keep_index]\n\
Usage: fuck.sh [-noclean_files]\n\n\
